...
The SPEC ZEP (abbreviation of Specification ZEP) introduces changes in the core
...
advice is that everyone should be made aware of the change by introducing core
ZEP. Core protocol ZEP require community consensus, and users are typically not
free to ignore them.
...
Council] can assign the ZEP this status when no progress is being made on the
ZEP.
...
mentioned previously. The ZSC and IC would take community consensus into account
...
the general Zarr community, and anyone else they, ZSC and IC think should be
...
their proposal. They may refer to [Discussing a ZEP] section to pick an avenue
...
[template.md]: https://github.com/MSanKeys963/governance/blob/master/ZEP/template/template.md